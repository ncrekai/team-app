               ...
               <div className='body-container'>
                  <div className='location-list'>
                     {list.items.map((item, i) => (
                        <ListItem key={`list-item-${i}`} item={item} />
                     ))}
                  </div>
                  <div>
                  ...
                  {/* {addItem ? (
                     <AddItem setAddItem={setAddItem} tripId={tripRef.current} />
                  ) : (
   ...
   return (
    <div className='display-list-container'>
      <div className='display-list'>
         ...
         {/* <div className='input-container'>
            <input onClick={handleDelete} className='button' type='submit' value='Add to List' />
            <input onClick={handleCheck} className='' type='checkbox' value={item._id} />
          </div> */}
